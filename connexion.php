    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-4">
            <div class="card shadow">
                <nav class="navbar navbar-expand-lg" style="background: linear-gradient(to right, rgb(218, 218, 218), rgb(182, 182, 182));" height= "50px;text-center">
                    <div class="container">
                        Connexion
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    try {
                        ...
                        if (!empty($_POST['id']) && !empty($_POST['md'])) {
                            ...
                            if (password_verify($md, $hash)) {
                                ...
                                echo '<div class="alert alert-danger text-center mt-3">Identifiant ou mot de passe incorrect.</div>';
                            }
                        }
                            else {
                                    echo '<div class="alert alert-danger text-center mt-3">Identifiant ou mot de passe incorrect.</div>';
                    ...
                    <?php if (empty($_SESSION['id'])): ?>
                        <form action="" method="post" class="mt-3">
                            ...
                            <button type="submit" class="btn btn-primary w-100" style="background-color: rgb(0, 0, 0); color: white;">Connexion</button>
                        </form>
                    <?php else: ?>
